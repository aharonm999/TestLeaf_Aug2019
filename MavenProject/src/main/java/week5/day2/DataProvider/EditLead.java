...
public class EditLead extends ProjectSpecificMethods{
	...
	/*	System.setProperty("webdriver.chrome.driver", "./drivers/chromedriver.exe");
		...
		driver.findElementByXPath("(//input[@name='firstName'])[3]").sendKeys(fName);//Here we are passing String arguments "fName"
		driver.findElementByXPath("(//input[@name='lastName'])[3]").sendKeys(lName);//Here we are passing String arguments "lName"
		...
		driver.findElementByXPath("//input[@id='updateLeadForm_companyName']").sendKeys(cName);//Here we are passing String arguments "cName"	
