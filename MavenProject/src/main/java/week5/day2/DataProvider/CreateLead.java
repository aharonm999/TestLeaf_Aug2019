...
public class CreateLead extends ProjectSpecificMethods{
	...
	/*	System.setProperty("webdriver.chrome.driver", "./drivers/chromedriver.exe");
		...
		driver.findElementById("createLeadForm_companyName").sendKeys(cName);//Here we are passing String arguments "cName"
		driver.findElementById("createLeadForm_firstName").sendKeys(fName);//Here we are passing String arguments "fName"
		driver.findElementById("createLeadForm_lastName").sendKeys(lName);//Here we are passing String arguments "lName"
